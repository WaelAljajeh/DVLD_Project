...
namespace DVLD_Project
{
    public partial class ucDLAPPInfo : UserControl
    {
       ...
       void FillDrivingLicenseApplicationInfo(int LocalDrivingLicenseAppID)
        {
            clsLocalDrivingLicenese localDrivingLicenese = clsLocalDrivingLicenese.GetLocalDrivingIDByInfo(LocalDrivingLicenseAppID);
            ...
            lblPassedTestCount.Text = localDrivingLicenese.PassedTestCount.ToString();

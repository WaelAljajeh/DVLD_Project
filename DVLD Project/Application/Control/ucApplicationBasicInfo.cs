...
namespace DVLD_Project
{
    public partial class ucApplicationBasicInfo : UserControl
    {
        ...
        {
             Application= clsApplication.FindBaseApplication(ApplicationInfoID);
            if (Application==null)
            {
                return;
            }

...
namespace DVLD_Project
{
    public partial class frmIssueInternationalLicense : Form
    {
        ...
        void LoadDefaultBasinInfo()
        {
            ...
            lblFees.Text = clsApplicationTypes.GetApplicationTypePaidFees((int)clsApplicationTypes.ApplicationType).ToString();
        ...
        {
            frmPersonLicenseHistory frmPersonLicense = new frmPersonLicenseHistory(ucDriverLicenseWithFilter1.SelectedLicense.DriverInfo.PerosnID);

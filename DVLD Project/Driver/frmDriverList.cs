...
namespace DVLD_Project
{
    public partial class frmDriverList : Form
    {
        ...
        {
            frmPersonLicenseHistory frmPersonLicenseHistory = new frmPersonLicenseHistory((int)dgvDriversList.CurrentRow.Cells[1].Value);
            frmPersonLicenseHistory.ShowDialog();
        }

        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmPersonDetails frmPersonDetails = new frmPersonDetails((int)dgvDriversList.CurrentRow.Cells[1].Value);

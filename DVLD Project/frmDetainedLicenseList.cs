...
namespace DVLD_Project
{
    public partial class frmDetainedLicenseList : Form
    {
        ...
        {
            clsApplication application = clsApplication.Find((int)dgvDetainLicensesList.CurrentRow.Cells["ReleaseApplicationID"].Value);
        ...
        {
            int PersonID = clsApplication.Find((int)dgvDetainLicensesList.CurrentRow.Cells["ReleaseApplicationID"].Value).ApplicationPersonID;
        ...
        {
            if(!(bool)dgvDetainLicensesList.CurrentRow.Cells["IsReleased"].Value)
            {
